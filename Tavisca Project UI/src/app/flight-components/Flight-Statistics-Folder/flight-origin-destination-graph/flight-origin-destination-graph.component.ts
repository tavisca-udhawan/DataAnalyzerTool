...
export class FlightOriginDestinationGraphComponent implements OnInit {
  ...
  ngOnInit(){
    ...
    reRender()
    {
      ...
      this.service.httpResponseFilters("Air","BookingsForSpecificTrip?fromDate="+ this.service.start +" 00:00:00.000&toDate="+this.service.end+" 00:00:00.000&departAirportCode=LAX&arrivalAirportCode=LAS")
      .subscribe( data=>{
