...
export class HotelBookingStatusStatsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.service.httpResponseFilters("Hotels","TotalBookings?fromDate="+ this.service.start +" 00:00:00.000&toDate="+this.service.end+" 00:00:00.000&location="+this.service.location)
    .subscribe( data=>{
