...
export class FlightBookingStatusStatsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.service.httpResponseFilters("Air","TotalBookings?fromDate="+ this.service.start +" 00:00:00.000&toDate="+this.service.end+" 00:00:00.000&location="+this.service.location)
    .subscribe( data=>{
 ...
 setDataPoints(xAxis, yAxis)
    ...
    DisplayGraph(chart ) {
      ...
      var chart = new CanvasJS.Chart("stats-flights", {
        zoomEnabled:true,
